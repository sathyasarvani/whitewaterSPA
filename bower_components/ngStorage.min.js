/*! ngstorage 0.3.9 | Copyright (c) 2015 Gias Kay Lee | MIT License */
!function (a, b) {
    "use strict";
        ...
        return function () {
            ...
            this.setSerializer = function (a) {
                ...
                var k, l, m = c.length, n = j(b) || (h.warn("This browser does not support Web Storage!"), {
                    ...
                    $default: function (b) {
                        for (var c in b)a.isDefined(o[c]) || (o[c] = a.copy(b[c]));
                        return o.$sync(), o
                    }, $reset: function (a) {
                ...
                return o.$sync(), k = a.copy(o), f.$watch(function () {
                    ...
                    c === b.key.slice(0, m) && (b.newValue ? o[b.key.slice(m)] = e(b.newValue) : delete o[b.key.slice(m)], k = a.copy(o), f.$apply())
